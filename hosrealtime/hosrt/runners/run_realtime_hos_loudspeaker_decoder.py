...
from hosrealtime.hosrt import RealtimeHOSLoudspeakerDecoder
...
useGainCompensation  = True # Adaptive loudspeaker array gain compensation 
...
renderer = RealtimeHOSLoudspeakerDecoder(context, "HOSRenderer", None,                                               
